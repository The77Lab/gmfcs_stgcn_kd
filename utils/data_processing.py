...
class Preprocess_Module:
    ...
    def __init__(self, data_augmentation, mode='fix'):
        self.transforms = []
        self.transforms.append(PreNormalize2D(img_shape=(320, 480), threshold=0.01,data_augmentation=data_augmentation, mode=mode))
